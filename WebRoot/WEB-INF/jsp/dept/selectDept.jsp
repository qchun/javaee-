	...
	<table border="1" cellspacing="0" cellpadding="0" width="80%">
		<tr align="center" height="30px">
			<td>
				...
				<input type="submit" value="删除" onclick="javascript:return confirm('确认删除这些部门吗？');"/>
			</td>
			<td>部门名</td>
			<td>备注</td>
			<td>操作</td>
		</tr>
		<c:forEach items="${requestScope.deptList}" var="dl">
			<tr align="center" height="30px">
				<td><input type="checkbox" name="ids" value="${dl.id }"/></td>
				<td>${dl.name }</td>
				<td>${dl.remark }</td>
				<td>
					<a href="updateDeptView?id=${dl.id}">修改</a>&nbsp;&nbsp;&nbsp;
					<a href="deleteDept?id=${dl.id}" onclick="javascript:return a();">删除</a>
				</td>
			</tr>
		</c:forEach>
	</table>
